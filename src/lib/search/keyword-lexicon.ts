...
const PRODUCT_CONCEPTS: ProductConcept[] = [
  ...
  { id: 'blazer', canonical: 'blazer', synonyms: ['blazers', 'sport coat', 'sport jacket', 'suit jacket', 'formal jacket', 'business jacket', 'office blazer', 'casual blazer', 'slim blazer', 'fitted blazer', 'oversized blazer', 'plaid blazer', 'tweed blazer', 'single breasted blazer', 'double breasted blazer'], required: true, genderClass: 'neutral' },
  { id: 'jacket', canonical: 'jacket', synonyms: ['jackets', 'outerwear', 'outer wear', 'bomber jacket', 'bomber', 'denim jacket', 'leather jacket', 'windbreaker', 'rain jacket', 'flight jacket', 'varsity jacket', 'trucker jacket', 'motorcycle jacket', 'biker jacket', 'quilted jacket', 'puffer jacket', 'padded jacket'], required: true, genderClass: 'neutral' },
  { id: 'coat', canonical: 'coat', synonyms: ['coats', 'overcoat', 'overcoats', 'trench', 'trench coat', 'parka', 'parkas', 'winter coat', 'wool coat', 'long coat', 'down coat', 'fur coat', 'faux fur coat', 'peacoat', 'duffle coat', 'camel coat'], required: true, genderClass: 'neutral' },
  { id: 'down', canonical: 'down jacket', synonyms: ['down jackets', 'puffer', 'puffers', 'puffy jacket', 'puffy coat', 'padded coat', 'quilted coat', 'winter jacket', 'warm jacket'], required: true, genderClass: 'neutral' },
