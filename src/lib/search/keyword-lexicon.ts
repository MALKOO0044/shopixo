...
const PRODUCT_CONCEPTS: ProductConcept[] = [
  { id: 'dress', canonical: 'dress', synonyms: ['dresses', 'gown', 'gowns', 'frock', 'frocks', 'maxi dress', 'midi dress', 'mini dress', 'evening dress', 'cocktail dress', 'sundress', 'sundresses'], required: true, genderClass: 'neutral' },
  ...
  { id: 'jacket', canonical: 'jacket', synonyms: ['jackets', 'blazer', 'blazers', 'sport coat', 'sport jacket'], required: true, genderClass: 'neutral' },
  { id: 'coat', canonical: 'coat', synonyms: ['coats', 'overcoat', 'overcoats', 'trench', 'trench coat', 'parka', 'parkas'], required: true, genderClass: 'neutral' },
