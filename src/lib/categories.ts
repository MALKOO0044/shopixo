...
export const FULL_CATEGORIES: FullCategory[] = [
  {
    ...
    children: [
      { slug: "women-coats-jackets", label: "معاطف وسترات نسائية", image: "https://images.unsplash.com/photo-1600218464426-8e5224a3542a?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-tshirts", label: "تيشيرتات للنساء", image: "https://images.unsplash.com/photo-1532074205216-d0e1f4b87368?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-dresses", label: "فساتين للنساء", image: "https://images.unsplash.com/photo-1595503289539-a8f28b2d0e5f?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-jackets", label: "سترات للنساء", image: "https://images.unsplash.com/photo-1582142391830-a4d1a491879a?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-sets", label: "أطقم نسائية من قطعتين", image: "https://images.unsplash.com/photo-1617137968429-90d5d3b61463?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-blouses-shirts", label: "بلوزات وقمصان للنساء", image: "https://images.unsplash.com/photo-1620799140408-edc6d5f9650d?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-trousers", label: "بناطيل للنساء", image: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-denim", label: "ملابس جينز للنساء", image: "https://images.unsplash.com/photo-1604176354204-926873782855?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-sweatshirts", label: "سترات سويت شيرت للنساء", image: "https://images.unsplash.com/photo-1556306535-0f694a20e24b?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-activewear", label: "ملابس رياضية للنساء", image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-sleeveless-cami", label: "بلوزات بدون أكمام وقمصان بحمالات للنساء", image: "https://images.unsplash.com/photo-1620799140408-edc6d5f9650d?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-wedding", label: "ملابس نسائية لحفلات الزفاف", image: "https://images.unsplash.com/photo-1590393748494-096c684f354a?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-track-jackets", label: "سترات رياضية", image: "https://images.unsplash.com/photo-1556306535-0f694a20e24b?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-work-safety", label: "ملابس العمل والسلامة للنساء", image: "https://images.unsplash.com/photo-1517423568366-8b83523034fd?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-traditional", label: "ملابس تقليدية وذات طابع ثقافي للنساء", image: "https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-denim-jackets", label: "جاكيتات ومعاطف جينز نسائية", image: "https://images.unsplash.com/photo-1549212952-03ef5a3c0423?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-denim-skirts", label: "تنانير من الجينز النساء", image: "https://images.unsplash.com/photo-1582414262945-8c4d0439378a?q=80&w=640&auto=format&fit=crop" },
