...
export const FULL_CATEGORIES: FullCategory[] = [
  {
    ...
    children: [
      // Dresses
      { slug: "women-dresses", label: "الفساتين (كلها)", image: "https://images.unsplash.com/photo-1595503289539-a8f28b2d0e5f?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-long-maxi", label: "فساتين طويلة / ماكسي", image: "https://images.unsplash.com/photo-1614413876114-0427c0163e35?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-midi", label: "فساتين ميدي", image: "https://images.unsplash.com/photo-1622618339316-2f34d85833bc?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-mini-short", label: "فساتين قصيرة / ميني", image: "https://images.unsplash.com/photo-1594618332904-92f63bab08f7?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-evening", label: "فساتين سهرة / حفلات", image: "https://images.unsplash.com/photo-1590393748494-096c684f354a?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-work-formal", label: "فساتين مكتب / رسمية", image: "https://images.unsplash.com/photo-1620531815525-a82a7f01a3b8?q=80&w=640&auto=format&fit=crop" },
      // Tops
      { slug: "women-tees", label: "تي شيرتات", image: "https://images.unsplash.com/photo-1581655353564-df123a5fae20?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-skirts", label: "تنانير", image: "https://images.unsplash.com/photo-1582414262945-8c4d0439378a?q=80&w=640&auto=format&fit=crop" },
      // Outerwear
      { slug: "women-coats", label: "معاطف شتوية", image: "https://images.unsplash.com/photo-1600218464426-8e5224a3542a?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-blazers", label: "بلايزر / بليزرات", image: "https://images.unsplash.com/photo-1582142391830-a4d1a491879a?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-faux-leather", label: "جاكيتات جلد صناعي", image: "https://images.unsplash.com/photo-1549212952-03ef5a3c0423?q=80&w=640&auto=format&fit=crop" },
      // Sets & Jumpsuits
      { slug: "women-sets", label: "أطقم (قطعتين/ثلاث)", image: "https://images.unsplash.com/photo-1617137968429-90d5d3b61463?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-jumpsuits", label: "الجمبسوت والرامبرز", image: "https://images.unsplash.com/photo-1600218464338-c411a0192343?q=80&w=640&auto=format&fit=crop" },
      // Lingerie & Sleepwear
      { slug: "women-bras", label: "صدريات", image: "https://images.unsplash.com/photo-1585144723202-13838a1a4884?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-pajamas", label: "ملابس نوم/بيجامات", image: "https://images.unsplash.com/photo-1617025121133-5c6c9a419a4e?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-shapewear", label: "شاب وير / مشدات", image: "https://images.unsplash.com/photo-1617137968429-90d5d3b61463?q=80&w=640&auto=format&fit=crop" },
      // Swim & Beachwear
      { slug: "women-bikinis", label: "بيكيني", image: "https://images.unsplash.com/photo-1577741314755-327d54777620?q=80&w=640&auto=format&fit=crop" },
