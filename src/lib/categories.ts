...
export const FULL_CATEGORIES: FullCategory[] = [
  ...
  { slug: "office-school", label: "مستلزمات مكتبية ومدرسية", image: "https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=640&auto=format&fit=crop" },
  { slug: "tools-home-improvement", label: "أدوات وتحسين المنزل", image: "https://images.unsplash.com/photo-1581090700227-1e37b190418e?q=80&w=640&auto=format&fit=crop" },
  { slug: "automotive", label: "السيارات", image: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?q=80&w=640&auto=format&fit=crop" },
  { slug: "pet-supplies", label: "مستلزمات الحيوانات الأليفة", image: "https://images.unsplash.com/photo-1543852786-1cf6624b9987?q=80&w=640&auto=format&fit=crop" },
  { slug: "baby-maternity", label: "الأطفال والأمومة", image: "https://images.unsplash.com/photo-1519681393784-d120267933ba?q=80&w=640&auto=format&fit=crop" },
