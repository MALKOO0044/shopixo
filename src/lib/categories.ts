...
export const FULL_CATEGORIES: FullCategory[] = [
  {
    ...
    children: [
      ...
      { slug: "women-sweaters", label: "كنزات نسائية", image: "https://images.unsplash.com/photo-1616258417201-3758611b84a6?q=80&w=640&auto=format&fit=crop" },
      { slug: "women-two-piece-sets", label: "أطقم نسائية من قطعتين", image: "https://images.unsplash.com/photo-1617137968429-90d5d3b61463?q=80&w=640&auto=format&fit=crop" },
      ...
      { slug: "women-jeans", label: "جينز للنساء", image: "https://images.unsplash.com/photo-1604176354204-926873782855?q=80&w=640&auto=format&fit=crop" },
