    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200 p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-blue-900">وقت التوصيل</h3>
          </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border border-green-200 p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold text-green-900">تكلفة الشحن</h3>
          </div>

          {availableVariants.length > 0 ? (
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-green-700">الحد الأدنى:</span>
                <span className="text-xl font-bold text-green-800">
                  {minShipping.toFixed(0)} ر.س
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-green-700">الحد الأقصى:</span>
                <span className="text-xl font-bold text-green-800">
                  {maxShipping.toFixed(0)} ر.س
                </span>
              </div>
            </div>
          ) : (
            <p className="text-green-600 italic">لا توجد خيارات شحن متاحة</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h3 className="text-lg font-bold text-gray-900">مزود الشحن</h3>
        </div>
        ...
        {uniqueLogistics.length > 0 ? (
          ...
          <p className="text-gray-400 italic">غير محدد</p>
        )}
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h3 className="text-lg font-bold text-gray-900">التوفر للشحن للسعودية</h3>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm text-green-700">متاح للشحن</span>
              </div>
              <span className="text-2xl font-bold text-green-800">
                {availableVariants.length}
              </span>
              <span className="text-sm text-green-600 mr-1">متغير</span>
            </div>

            <div className="bg-red-50 rounded-lg p-4 border border-red-200">
              <div className="flex items-center gap-2 mb-2">
                <XCircle className="h-4 w-4 text-red-600" />
                <span className="text-sm text-red-700">غير متاح</span>
              </div>
              <span className="text-2xl font-bold text-red-800">
                {unavailableVariants.length}
              </span>
              <span className="text-sm text-red-600 mr-1">متغير</span>
            </div>
          </div>
        </div>
      </div>
