      ...
      <div className="container pb-6">
        <div className="flex items-start justify-between gap-4 rounded-xl border bg-white p-4 shadow-lg">
          <p className="text-sm text-slate-700">
            We use cookies to enhance your experience, analyze traffic, and for marketing. By continuing, you agree to our Privacy Policy.
          </p>
          <div className="flex shrink-0 gap-2">
            <button className="rounded-md border px-3 py-2 text-sm" onClick={() => { localStorage.setItem(KEY, "dismiss"); setOpen(false); }}>Dismiss</button>
