...
function isAllowedNextImage(src: string): boolean {
  ...
  try {
    ...
    // Keep CJ/Alibaba CDNs on native <img>; some endpoints can reject optimizer fetches.
    if (host === 'cjdropshipping.com' || host.endsWith('.cjdropshipping.com')) return false;
    if (host.includes('alicdn.com') || host.includes('aliyuncs.com')) return false;
  } catch {
