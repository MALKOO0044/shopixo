    ...
    <div className="container py-10">
      ...
      <div className="mt-6 max-w-md rounded-xl border bg-white p-6 shadow-sm">
        <form method="get" className="flex gap-2">
          <input name="id" defaultValue={idParam} placeholder="Order #" className="w-full rounded-md border px-3 py-2" />
        ...
        {order && (
          <div className="mt-4 text-sm text-slate-700">
            ...
            <div>الإجمالي: <span className="font-medium">${'{'}order.total_amount{'}'}</span></div>
